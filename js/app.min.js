...
const lang = () => {
    ...
    const currentPageArr = window.location.pathname.split('/');
    const currentPage = currentPageArr[currentPageArr.length - 1];

    if (langBtns.length) {
        langBtns.forEach((langBtn) => {
            if (langBtn.innerHTML.toLowerCase() === 'ru' && !currentPageArr.includes('ru')) {
                langBtn.href = './' + langBtn.innerHTML.toLowerCase() + '/' + currentPage;
            } else if (langBtn.innerHTML.toLowerCase() === 'ru' && currentPageArr.includes('ru')) {
                langBtn.href = './' + currentPage;
            }
